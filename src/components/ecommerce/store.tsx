...
export function CartProvider({ children }: { children: ReactNode }) {
  ...
  const [category, setCategoryState] = useState<string>("Todos");
  ...
  return <Ctx.Provider value={{ items, add, remove, count, total, open, setOpen, category, setCategory }}>{children}</Ctx.Provider>;
}
